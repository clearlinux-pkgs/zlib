...
export LANG=C
export SOURCE_DATE_EPOCH=1555364597
export AR=gcc-ar
...
CFLAGS="${CFLAGS_GENERATE}" CXXFLAGS="${CXXFLAGS_GENERATE}" FFLAGS="${FFLAGS_GENERATE}" FCFLAGS="${FCFLAGS_GENERATE}" %configure --disable-static --static --shared
make  %{?_smp_mflags}
...
make clean
CFLAGS="${CFLAGS_USE}" CXXFLAGS="${CXXFLAGS_USE}" FFLAGS="${FFLAGS_USE}" FCFLAGS="${FCFLAGS_USE}" %configure --disable-static --static --shared
make  %{?_smp_mflags}
...
%configure --disable-static --static --shared   --libdir=/usr/lib32 --build=i686-generic-linux-gnu --host=i686-generic-linux-gnu --target=i686-clr-linux-gnu
make  %{?_smp_mflags}
popd
...
%configure --disable-static --static --shared
make  %{?_smp_mflags}
popd
%check
export LANG=C
